...
public class GeoJsonMultiple {
	...
	public void setGeometry(String type, List<List<BigDecimal>> coordinates) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GeoJsonMultiple other = (GeoJsonMultiple) obj;
		if (geometry == null) {
	...
	public class Geometry implements Serializable{
		...
		public Geometry(String type, List<List<BigDecimal>> coordinates) {
			super();
			this.type = type;
